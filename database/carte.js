const carte = [
  //assiette
  { type: "assiette", name: "kebab", price: 10 },
  { type: "assiette", name: "grillade", price: 14 },
  { type: "assiette", name: "aubergine farcie", price: 10 },
  { type: "assiette", name: "kofte", price: 12 },
  { type: "assiette", name: "omelette", price: 9 },
  { type: "assiette", name: "menemen", price: 12 },
  { type: "assiette", name: "poulet", price: 12 },
  { type: "assiette", name: "agneau", price: 12 },
  { type: "assiette", name: "steack", price: 9 },
  { type: "assiette", name: "iskender", price: 12 },
  { type: "assiette", name: "alti ezme", price: 12 },
  { type: "assiette", name: "merguez", price: 10 },
  { type: "assiette", name: "suçuk", price: 10 },
  { type: "assiette", name: "beyti", price: 13 },
  { type: "assiette", name: "hunkar begendi", price: 13 },
  { type: "assiette", name: "montagnard", price: 12 },
  { type: "assiette", name: "vegetarienne feta", price: 7.7 },
  { type: "assiette", name: "mexicaine", price: 12 },
  //accompagnement
  ...
  //sandwich frites
  { type: "sandwich frites", name: "kebab frites", price: 6 },
  { type: "sandwich frites", name: "kebab cheese frites", price: 7 },
  { type: "sandwich frites", name: "maxi frites", price: 9 },
  { type: "sandwich frites", name: "maxi cheese frites", price: 9.5 },
  { type: "sandwich frites", name: "suçuk frites", price: 6 },
  { type: "sandwich frites", name: "kofte frites", price: 6 },
  { type: "sandwich frites", name: "lahmacun frites", price: 6 },
  { type: "sandwich frites", name: "durum frites", price: 6.5 },
  { type: "sandwich frites", name: "durum cheese frites", price: 7.5 },
  ...
  { type: "soda à emporter", name: "dada pomme", price: 1.8 },
  { type: "soda à emporter", name: "dada cerise", price: 1.8 },
  { type: "soda à emporter", name: "dada litchi", price: 1.8 },
  ...
  //boisson chaude
  { type: "boisson chaude", name: "cafe", price: 1.8 },
  { type: "boisson chaude", name: "grand cafe", price: 1.8 },
